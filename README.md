...
--------        |  --------------------|--------------| ------------------------  |
SuppFigxx-Cust_PCA_allSamples_April_2023_withoutPath.pdf | [[PDF](Figures_Tables/SuppFigxx-Cust_PCA_allSamples_April_2023_withoutPath.pdf)]|<IMG SRC="Figures_Tables/SuppFigxx-Cust_PCA_allSamples_April_2023_withoutPath.png" width=300px> | PCA plot shows top 2000 variable genes clustering of different time points together with either KO or WT  analysed by RNA-Seq. |
